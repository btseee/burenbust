    ...
    <>
      <div className="blog-testi">
        ...
        <p className="blog-testi__desc">
          ...
          industrial properties. Real estate agents play a crucial role in
          facilitating at transactions and helping commercial, and
          industrial{" "}
        </p>
        <div className="blog-testi__bottom flx-between">
          <span className="blog-testi__name text-gradient">Mark wood</span>
          <img
            src="assets/images/icons/quote-two.svg"
            alt=""
            className="blog-testi__quote"
          />
        </div>
      </div>
    </>
