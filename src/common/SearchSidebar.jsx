...
const SearchSidebar = () => {
  const { handleDataStatusChange, handleDataTypeChange, handleSortChange } =
      ...
      <div className="search-sidebar">
        <form action="#" method="post" autoComplete="off">
              ...
              return (
                <div className="common-check" key={searchAmenityIndex}>
                  <input
                    className="form-check-input"
                    type="checkbox"
                    id={searchAmenity.text}
                  />
                  <label
                    className="form-check-label"
                    htmlFor={searchAmenity.text}
                  >
                    {searchAmenity.text}
                  </label>
                </div>
          ...
          <div className="search-sidebar__item position-relative">
            ...
            <label className="custom--range__text mb-2 text-text-capitalize">
              Your range:
            </label>
