        ...
        <ul className="comment-list">
          <li className="comment-list__item d-flex">
            ...
            <div className="comment-list__content">
                ...
                <ul className="social-list mt-0 p-0 border-0 gap-3">
                  <li className="social-list__item">
                    <Link
                      ...
                      className="social-list__link text-gradient font-12 flx-center"
                    >
              ...
              <p className="comment-list__desc">
                ...
                that a reader will be distrol acted Aliquam eros justo.
              </p>
              <a className="comment-list__reply" href="#comment-box">
                {" "}
                Reply{" "}
              </a>
            </div>
