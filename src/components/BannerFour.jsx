  ...
  return (
    <section className="banner-four">
      ...
      <img
        ...
        alt="Shape"
        className="banner-four-shape one"
      />
      <img
        src="assets/images/shapes/angle-left.png"
        alt="Shape"
        className="banner-four-shape two"
      />
      <img
        src="assets/images/shapes/angle-right.png"
        alt="Shape"
        className="banner-four-shape three"
      />
      <div
        className="banner-four__inner"
        style={{
      ...
      >
        <div className="container">
          <div className="banner-four-content">
            <span className="banner-four-content__subtitle">
              FinTech Fusion
            </span>
            <h1 className="banner-four-content__title">
              Invest today in You{" "}
