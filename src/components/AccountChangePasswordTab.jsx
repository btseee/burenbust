          ...
          <div className="card-body">
            ...
            <div className="row gy-lg-4 gy-3">
              <div className="col-12">
                <label htmlFor="current-passwordd" className="form-label">
                  Current Password
                </label>
              ...
              <div className="col-12">
                <label htmlFor="new-passwordd" className="form-label">
                  New Password
                </label>
                <div className="position-relative">
                  <input
              ...
              <div className="col-12">
                <label htmlFor="confirm-passwordd" className="form-label">
                  Confirm Password
                </label>
                <div className="position-relative">
                  <input
