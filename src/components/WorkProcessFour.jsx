...
const WorkProcessFour = () => {
  return (
    <section className="working-process padding-b-60">
      <img
        src="assets/images/shapes/work-process-vector.png"
        alt=""
        className="working-process__shape d-lg-block d-none"
      />
        ...
        <div className="row section-heading style-left max-w-unset">
          ...
          <div className="col-lg-6">
            <p className="section-heading__desc font-18">
              Real estate is a lucrative ind involves the buying selling and
              Real estate a is a lucrative indinvolves buyingrep pertiese
              compasses sidential eproperties. It encompasses residential
              lucrative ind involves the buying selling and Real estate
              lucrative ind involves the buying
            </p>
          </div>
        </div>
        ...
        <div className="row gy-4">
          ...
          <div className="col-lg-6">
            <div className="working-process-item d-flex align-items-center">
              <Link to="/project" className="working-process-item__link">
              ...
              <div className="working-process-item__content">
                ...
                <p className="working-process-item__desc font-18">
            ...
            <div className="working-process-item d-flex align-items-center">
              ...
              <div className="working-process-item__content">
                <h6 className="working-process-item__title">
                  Property Management
                </h6>
                <p className="working-process-item__desc font-18">
                  Lorem ipsum dolor sit amet consectetur
