...
} from "../data/OthersPageData/OthersPageData";
          ...
          <div className="row gy-4">
            <div className="col-lg-8">
              ...
              <p className="property-details__desc mb-3">
                {location.state.desc.slice(0, 178)}
              </p>
              <p className="property-details__desc">
                {location.state.desc.slice(179, 400)}
              </p>
              ...
              <div className="property-details-wrapper">
                ...
                <div className="property-details-item">
                  ...
                  <div className="property-details-item__content">
                    <div className="row gy-4">
                      {addressContents.map(
                        (addressContent, addressContentIndex) => {
                          return (
                  ...
                  <div className="property-details-item__content">
                    <div className="house-content position-relative">
                      ...
                      <Link
                        ...
                        className="popup-video-link video-popup__button style-two"
                      >
