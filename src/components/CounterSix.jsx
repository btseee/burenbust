              ...
              <div className="counter-six-item">
                <div className="d-flex align-items-center gap-2 gap-sm-3">
                  <span className="counter-six-item__icon">
                    <img
                      src="assets/images/icons/counter-six-img1.svg"
                      alt=""
                    />
                  </span>
                ...
                <span className="counter-six-item__text font-18">
                  HAPPY PATIENTS
                </span>
              </div>
            </div>
            <div className="col-lg-3 col-6">
              <div className="counter-six-item">
                <div className="d-flex align-items-center gap-2 gap-sm-3">
                  <span className="counter-six-item__icon">
                    <img
                      src="assets/images/icons/counter-six-img2.svg"
                      alt=""
                    />
                  </span>
                  <h2 className="counter-six-item__number mb-0">
            ...
            <div className="col-lg-3 col-6">
              <div className="counter-six-item">
                <div className="d-flex align-items-center gap-2 gap-sm-3">
                  <span className="counter-six-item__icon">
                    <img
                      src="assets/images/icons/counter-six-img3.svg"
                      alt=""
                    />
                  </span>
                  <h2 className="counter-six-item__number mb-0">
            ...
            <div className="col-lg-3 col-6">
              <div className="counter-six-item">
                <div className="d-flex align-items-center gap-2 gap-sm-3">
                  <span className="counter-six-item__icon">
                    <img
                      src="assets/images/icons/counter-six-img4.svg"
                      alt=""
                    />
                  </span>
                  <h2 className="counter-six-item__number mb-0">
