        ...
        <div className="testimonial-four-slider overflow-hidden" ref={slider}>
          <Slider {...settings} ref={slider}>
            <div className="testimonial-item style-two style-four">
              <p className="testimonial-item__desc mt-0">
                Real estate is a lucrativ ind involves the buying selling and
                Real estate a is a lucrative indinvolves buyingrep pertiesen cos
                residentialreproperties. It encompasses residential Real estate
                a is a lucrative
              </p>
              <div className="testimonial-item__top flx-between gap-2">
                <div className="testimonial-item__info d-flex align-items-center">
                  ...
                  <div>
                    ...
                    <span className="testimonial-item__designation text-gradient">
                      Prime Investments
                    </span>
                  </div>
                </div>
                <span className="testimonial-item__quote">
