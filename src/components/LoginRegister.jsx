...
const LoginRegister = ({
  ...
  const renderUsernameError = formik.touched.username &&
                      ...
                      <div className="row gy-lg-4 gy-3">
                        ...
                        <div className={passwordCol}>
                          ...
                          <div className="position-relative">
                            ...
                            />
                            <span
                              className={`password-show-hide ${showPassword ? "fas fa-eye " : "fas fa-eye-slash"} `}
                        ...
                        {showConfirm && (
                          <div className="col-sm-6 col-xs-6">
                            ...
                            <div className="position-relative">
                              ...
                              />
                              <span
                                className={`password-show-hide ${showConfirmPassword ? "fas fa-eye " : "fas fa-eye-slash"} `}
