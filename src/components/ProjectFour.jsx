      ...
      <div className="container container-two">
        <div className="d-flex align-items-sm-center flex-sm-row flex-column gap-4 mb-72">
          ...
          <div className="arrow-style-two d-flex align-items-center gap-3">
            <button
              className="slick-prev slick-arrow position-relative bottom-0 top-0 start-0"
              onClick={() => slider?.current?.slickPrev()}
            >
              <i className="fas fa-arrow-left"></i>
            </button>
            <button
              className="slick-next slick-arrow position-relative bottom-0 top-0 start-0"
