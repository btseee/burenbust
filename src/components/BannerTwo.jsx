    ...
    <>
      ...
      <div className="banner-two">
        <div className="container container-two">
            ...
            <div className="contact-content">
              ...
              <div className="d-flex align-items-center gap-3">
                ...
                <div className="contact-content__infos">
                  <span className="contact-content__text">
                    {bannerTwoContent.text}
                  </span>
                  <Link
                    to={`${bannerTwoContent.numberLink}${bannerTwoContent.number}`}
                    className="contact-content__contact"
                  >
                    {bannerTwoContent.number}
                  </Link>
                </div>
              </div>
            </div>
          ...
          <div
            className="banner-two__filter background-img"
            style={{ backgroundImage: `url(${BannerTwoThumb})` }}
          >
