  ...
  return (
    <div className="blog-item border border-color">
      <div className="blog-item__thumb">
        <Link
          to={blogURL}
          state={{ thumb, title, admin, desc }}
          className="blog-item__thumb-link"
        >
          <img src={thumb} className="cover-img" alt="" />
        </Link>
        <span className="blog-item__date top-0 font-12 mt-3 end-0 me-4">
          {" "}
      ...
      <div className="blog-item__content bg-white border-0">
        ...
        <h6 className="blog-item__title mb-4">
          <Link
            to={blogURL}
            state={{ thumb, title, admin, desc }}
            className="blog-item__title-link border-effect"
          >
            {" "}
            {title}
          </Link>
        ...
        <Link
          to={blogURL}
          state={{ thumb, title, admin, desc }}
          className="simple-btn text-gradient fw-semibold"
        >
          {linkText}
