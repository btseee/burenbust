                ...
                <div className="card common-card min-w-maxContent">
                  <div className="card-body">
                              ...
                              <tr key={cartItemIndex}>
                                ...
                                <td>
                                  <div className="cart-item__count">
                                    ...
                                    <input
                                      type="number"
                                      value={quantities[cartItemIndex]}
                                      readOnly
                                    />
                                    <button
                                      className="increment-btn"
                                      onClick={() =>
                                        handleIncrement(cartItemIndex)
                                      }
                                    >
                                ...
                                <td>
                                  <h6 className="cart-item__totalPrice font-16 fw-500 mb-0">
                                    $
                                    {(
                                      quantities[cartItemIndex] *
                                ...
                                <td>
                                  <button
                                    type="button"
                                    onClick={() =>
                                      handleRemoveItem(cartItemIndex)
                                    }
                    ...
                    <div className="mt-5 d-flex align-items-center gap-4 justify-content-between">
                      ...
                      <button
                        type="button"
                        className="btn btn-outline-main bg-white flex-shrink-0"
                      >
                        {" "}
                        Update Cart{" "}
                      </button>
